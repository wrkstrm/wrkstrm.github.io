...
> [!IMPORTANT]
> Prefer **Swift** over Python/Bash for repo automation. New utilities should live in the agent’s SwiftPM **launchpad** (scratchpad → core) so they are discoverable, testable, and promotable.
