...
@Metadata {
  @PageImage(purpose: icon, source: "svg-simple-vector-graphics-hover-effects-icon", alt: "Icon")
  @PageImage(purpose: card, source: "svg-simple-vector-graphics-hover-effects-card", alt: "Card")
}
@Image(source: "svg-simple-vector-graphics-hover-effects-hero", alt: "Hero")
