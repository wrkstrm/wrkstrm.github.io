...
@Metadata {
  @PageImage(purpose: icon, source: "svg-simple-vector-graphics-docc-considerations-icon", alt: "Icon")
  @PageImage(purpose: card, source: "svg-simple-vector-graphics-docc-considerations-card", alt: "Card")
}
@Image(source: "svg-simple-vector-graphics-docc-considerations-hero", alt: "Hero")
