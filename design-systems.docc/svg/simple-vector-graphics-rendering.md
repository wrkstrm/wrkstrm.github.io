...
@Metadata {
  @PageImage(purpose: icon, source: "svg-simple-vector-graphics-rendering-icon", alt: "Icon")
  @PageImage(purpose: card, source: "svg-simple-vector-graphics-rendering-card", alt: "Card")
}
@Image(source: "svg-simple-vector-graphics-rendering-hero", alt: "Hero")
