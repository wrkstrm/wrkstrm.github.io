...
```md
  @PageImage(purpose: icon, source: "svg-svg-page-images-icon", alt: "Icon")
```
...
```md
  @PageImage(purpose: card, source: "svg-svg-page-images-card", alt: "Card")
```
...
@Image(source: "svg-svg-page-images-hero", alt: "Hero")
```
