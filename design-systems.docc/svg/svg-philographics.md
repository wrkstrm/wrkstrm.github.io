...
@Metadata {
  @PageImage(purpose: icon, source: "svg-svg-philographics-icon", alt: "Icon")
  @PageImage(purpose: card, source: "svg-svg-philographics-card", alt: "Card")
}
@Image(source: "svg-svg-philographics-hero", alt: "Hero")
